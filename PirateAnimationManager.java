...
public class PirateAnimationManager {
	...
	public void update() {
        ...
        if(currentAnimation.equals(animation) && dx > 0)
            dx = dx*-1; //change direction of walking based on animation position
        ...
        //pirate going left to the left of ninja
        if(x < ninjaAnimationManager.getX() && currentAnimation.equals(animation) && dx > 0)
            x = x - dx;

        else if(x < ninjaAnimationManager.getX() && currentAnimation.equals(animation) && dx < 0)
            x = x + dx;
        
        //pirate going left to the right of ninja
        else if(x > ninjaAnimationManager.getX() && currentAnimation.equals(animation) && dx > 0)
            x = x - dx;
        ...
        //pirate going right to the right of ninja
        else if(x > ninjaAnimationManager.getX() && currentAnimation.equals(animation1) && dx > 0)
            x = x + dx;

        else if(x > ninjaAnimationManager.getX() && currentAnimation.equals(animation1) && dx < 0)
            x = x - dx;

        //pirate going right to the left of ninja
        else if(x < ninjaAnimationManager.getX() && currentAnimation.equals(animation1) && dx > 0)
            x = x + dx;
